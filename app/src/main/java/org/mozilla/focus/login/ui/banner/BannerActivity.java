package org.mozilla.focus.login.ui.banner;
...
public class BannerActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        webView.addJavascriptInterface(new BannerActivity.WebBridge(),TAG_JAVA_INTERFACE);
        webView.setWebChromeClient(new WebChromeClient() {
            ...
            public boolean onCreateWindow(final WebView view, boolean bDialog, boolean userGesture, Message resultMsg)
            {
                ...
                WebView newWebView = new WebView(BannerActivity.this);
                WebSettings webSettings = newWebView.getSettings();
                webSettings.setJavaScriptEnabled(true);

                final Dialog dialog = new Dialog(BannerActivity.this);
            ...
            runOnUiThread(new Runnable() {
                ...
                public void run() {
                    ...
                    if (result == 1) {
                        ...
                        Toast.makeText(BannerActivity.this, getString(R.string.web_callback_error), Toast.LENGTH_SHORT).show();
                    }
                }
            });
        }
