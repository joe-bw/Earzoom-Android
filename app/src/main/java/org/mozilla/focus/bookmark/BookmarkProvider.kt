...
*/
            ...
            if (cursor != null) {
                if (cursor.moveToFirst()) {
                    ...
                    //val colorColumnIndex: Int = cursor.getColumnIndexOrThrow(Columns.COLOR)
                    ...
                    //val color: Int = cursor.getInt(colorColumnIndex)
            ...
            val uuid : Long = cursor!!.getLong( cursor.getColumnIndex(BaseColumns._ID) )
            val url : String = cursor.getString( cursor.getColumnIndex(Columns.URL) )
            val title : String = cursor.getString( cursor.getColumnIndex(Columns.TITLE) )
*/
