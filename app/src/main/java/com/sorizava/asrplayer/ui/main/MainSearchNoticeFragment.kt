...
class MainSearchNoticeFragment : BaseFragment<FragmentMainSearchNoticeBinding>(FragmentMainSearchNoticeBinding::inflate),
    ...
    companion object {
        fun newInstance() = MainSearchNoticeFragment()
    ...
    override fun initView() {
        ...
        toolbarIntegration.set(
            NewInputToolbarIntegration(
                browserToolbar,
                fragment = this@MainSearchNoticeFragment,
...
//        if (UrlInputFragment.ANIMATION_BROWSER_SCREEN == arguments?.getString(UrlInputFragment.ARGUMENT_ANIMATION)) {
